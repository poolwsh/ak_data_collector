...
DROP TABLE IF EXISTS ak_dg_tracing_date;
CREATE TABLE ak_dg_tracing_date (
...
DROP TABLE IF EXISTS ak_dg_tracing_date_1_param;
CREATE TABLE ak_dg_tracing_date_1_param (
    ak_func_name VARCHAR NOT NULL,
...
DROP TABLE IF EXISTS ak_dg_tracing_scode_date;
CREATE TABLE ak_dg_tracing_scode_date (
    ak_func_name VARCHAR NOT NULL,
