...
ak_cols_config = {
    ...
    "stock_board_concept_name_em": {
        ...
        "remove_list": [],
        "en_list": ['rank', 'b_name', 'b_code', 'c', 'change_amount', 'change_percentage', 
    ...
    "stock_board_industry_summary_ths": {
        ...
        "remove_list": ['序号'],
        "en_list": ['b_name', 'change_percentage', 'v', 'a', 'net_inflow', 'risers', 
    ...
    "stock_board_industry_name_em": {
        ...
        "remove_list": [],
        "en_list": ['rank', 'b_name', 'b_code', 'c', 'change_amount', 'change_percentage', 'total_mv', 
